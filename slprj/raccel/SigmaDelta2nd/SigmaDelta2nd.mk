...
MODEL                   = SigmaDelta2nd
MODULES                 = rt_logging_simtarget.c SigmaDelta2nd.c SigmaDelta2nd_capi.c SigmaDelta2nd_data.c SigmaDelta2nd_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = SigmaDelta2nd.exe
MAKEFILE                = SigmaDelta2nd.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2021b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2021b
START_DIR               = C:\Users\Utente\Documents\MATLAB\Projects\DSP
S_FUNCTIONS_LIB         = 
NUMST                   = 6
NCSTATES                = 2
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SigmaDelta2nd_ref.rsp
COMPILER_COMMAND_FILE     = SigmaDelta2nd_comp.rsp
